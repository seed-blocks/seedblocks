// https://github.com/emotion-js/emotion/blob/master/packages/is-prop-valid/src/props.js
...
const validPropsRegexString = `^((${Object.keys(propNames).join(
	"|"
)})|(([Dd][Aa][Tt][Aa]|[Aa][Rr][Ii][Aa]|x)-.*))$`;

export default validPropsRegexString;
